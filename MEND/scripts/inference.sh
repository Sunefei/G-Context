...
# task注意需重新命名与设计
task=class_to_class
state_dict_path="output/pytorch_model.bin"
output_dir='output_test'

# accelerate launch  --config_file accelerate_config.yaml main.py \
accelerate launch main.py \
      --output_dir ${output_dir} \
      --catched_file catched_data/${dataset_name}_time.torch \
      --eval_catched_file  catched_data/${dataset_name}_eval_time.torch \
      --seed 100 \
