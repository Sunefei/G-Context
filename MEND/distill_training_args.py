...
class DynamicDataTrainingArguments:
    ...
    catched_file: str = field(
        default='catched_data/cached-s_gpt2-t_gpt2-large-qa_to_qa-full.torch'
    )
    ...
    predict_with_generation: bool = field(
        default=True
    )
    # include_for_metrics: list = field(
...
class DynamicTrainingArguments(Seq2SeqTrainingArguments):
    ...
    output_dir:str=field(
        default='/data/syf/gsy/MEND/output/'
    )