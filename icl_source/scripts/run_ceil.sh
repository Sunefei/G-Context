...
#epr_model=output/epr/mrpc/gpt2-large/bert-fix_ctx-shared-bs64
#run_dir=output/dpp-epr-random/mrpc/gpt2-large
  ...
  #scored_file=output/dpp-epr-random/mrpc/gpt2-large/scored.json
  ...
  #run_name=base-mg0.02-s0.1-fix
  run_dir=${run_dir}/${run_name}
  
  #run_dir=output/dpp-epr-random/mrpc/gpt2-large/bert-fix_ctx-shared-bs64/base-mg0.02-s0.1-fix
  #accelerate launch --num_processes ${gpu} --main_process_port ${port}  
