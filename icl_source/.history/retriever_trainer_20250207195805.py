...
class RetrieverTrainer:
    ...
    def train(self):
        self.trainer.train()
        torch.save(self.trainer.model.question_model.state_dict(), f"{self.training_args.output_dir}/model_weights.pth")
        torch.save(self.trainer.model.ctx_model.state_dict(), f"{self.training_args.output_dir}/model_weights.pth")
        #self.trainer.save_model(self.training_args.output_dir, safe_serialization=False) 
