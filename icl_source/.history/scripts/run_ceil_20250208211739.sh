...
#run_dir=output/dpp-epr-random/mrpc/gpt2-large/bert-fix_ctx-shared-bs64
  ...
  #run_dir=output/dpp-epr-random/mrpc/gpt2-large/bert-fix_ctx-shared-bs64/base-mg0.02-s0.1-fi
