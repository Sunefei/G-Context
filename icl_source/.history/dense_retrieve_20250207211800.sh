...
#run_dir = output/epr/mrpc/gpt2-large
...
#retrieved_file = output/epr/mrpc/gpt2-large/retrieved.json
#index_data=index_data/mrpc/index_dataset.json
  retrieve_file=${run_dir}/retrieved.json
#scored_file=output/epr/mrpc/gpt2-large/scored.json
...
#retrieve_file = output/epr/mrpc/gpt2-large/bert-fix_ctx-shared-bs64/train_retrieved.json
