...
do
  ...
  CUDA_VISIBLE_DEVICES=1,3 accelerate launch --num_processes 2 launch scorer.py \
  CUDA_VISIBLE_DEVICES=1,3 accelerate launch --num_processes ${gpu} --main_process_port ${port} scorer.py \
